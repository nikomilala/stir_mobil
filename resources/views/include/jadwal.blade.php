        ...
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="h-100">
                    ...
                    <h1 class="display-6 mb-4">Belajar kapan saja Kami selalu ada untuk Anda</h1>
                    <p>Jadwal belajar stir mobil</p>
                    <h2>Senin - Sabtu : 07.00 - 22.00 WIB</h2>
                    <h2>Minggu        : 08.00–15.00</h2>
                    <div class="row g-4">
                        <div class="col-sm-6">
